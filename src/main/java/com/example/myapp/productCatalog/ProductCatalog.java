...
public class ProductCatalog {
    ...
    public void addProduct(int discriminator, String[] values){
        ...
        if(discriminator == 1) {
            product = new Tv(0, values[0], Double.parseDouble(values[1]), Double.parseDouble(values[2]), values[3], values[4]);
        } else if (discriminator == 2){
            product = new Monitor(0, values[0], Double.parseDouble(values[1]), Double.parseDouble(values[2]), values[3], Integer.parseInt(values[4]));
            ...
            product = new Tablet(0, values[0], Double.parseDouble(values[1]),Double.parseDouble(values[2]),values[3],values[4],values[5],Integer.parseInt(values[6]),Integer.parseInt(values[7]),Integer.parseInt(values[8]),
                    Double.parseDouble(values[9]),values[10],values[11],values[12]);
        } else if (discriminator == 4){
            product = new Desktop(0, values[0], Double.parseDouble(values[1]), Double.parseDouble(values[2]), values[3], values[4], values[5], Integer.parseInt(values[6]),Integer.parseInt(values[7]),Integer.parseInt(values[8]));
            ...
            product = new Laptop(0, values[0], Double.parseDouble(values[1]), Double.parseDouble(values[2]), values[3],values[4],Integer.parseInt(values[5]),Integer.parseInt(values[6]),Integer.parseInt(values[7]),
                    Double.parseDouble(values[8]), values[9], values[10], Boolean.parseBoolean(values[11]), Boolean.parseBoolean(values[12]));
        }
